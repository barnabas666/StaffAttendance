...
public class StaffPostgresServiceTests
{
    private readonly StaffPostgresService _sut;
    ...
    public StaffPostgresServiceTests()
    {
        _sut = new StaffPostgresService(_dbMock.Object, _staffDataMock.Object, _checkInDataMock.Object, _connectionStringMock.Object);
    }
    ...
    public async Task GetAllDepartmentsAsync_ShouldReturnListOfDepartments()
    {
        ...
        string sql = await QueryHelper.LoadPostgresQueryAsync("Departments_GetAll.sql");
    ...
    public async Task AliasVerificationAsync_ShouldReturnAlias_WhenAliasExists()
    {
        ...
        string sql = await QueryHelper.LoadPostgresQueryAsync("Aliases_GetByAliasAndPIN.sql");
    ...
    public async Task GetAllBasicStaffAsync_ShouldReturnListOfStaffBasicModel()
    {
        ...
        string sql = await QueryHelper.LoadPostgresQueryAsync("Staffs_GetAllBasic.sql");
    ...
    public async Task GetBasicStaffByIdAsync_ShouldReturnStaffBasicModel()
    {
        ...
        string sql = await QueryHelper.LoadPostgresQueryAsync("Staffs_GetBasicById.sql");
        _dbMock.Setup(db => db.LoadDataAsync<StaffBasicModel, dynamic>(
                sql, It.IsAny<object>(), It.IsAny<string>()))
    ...
    public async Task GetBasicStaffByAliasIdAsync_ShouldReturnStaffBasicModel()
    {
        ...
        string sql = await QueryHelper.LoadPostgresQueryAsync("Staffs_GetBasicByAliasId.sql");
        _dbMock.Setup(db => db.LoadDataAsync<StaffBasicModel, dynamic>(
                sql, It.IsAny<object>(), It.IsAny<string>()))
            .ReturnsAsync(new List<StaffBasicModel> { expectedStaff });
        // Act
    ...
    public async Task GetStaffEmailByIdAsync_ShouldReturnEmailAddress()
    {
        ...
        string sql = await QueryHelper.LoadPostgresQueryAsync("Staffs_GetEmailById.sql");
    ...
    public async Task CheckStaffByEmailAsync_ShouldReturnTrue_WhenStaffExists()
    {
        ...
        string sql = await QueryHelper.LoadPostgresQueryAsync("Staffs_CheckByEmail.sql");
    ...
    public async Task UpdateStaffByAdminAsync_ShouldCallSaveDataAsync()
    {
        ...
        string sql = await QueryHelper.LoadPostgresQueryAsync("Staffs_UpdateByAdmin.sql");
