...
public class StaffPostgresService : IStaffService
{
    ...
    public StaffPostgresService(IPostgresDataAccess db, IStaffData staffData, ICheckInData checkInData, IConnectionStringData connectionStringData)
    {
        _db = db;
