...
public class StaffBasicDtoToStaffManagementUpdateViewProfile : Profile
{
    public StaffBasicDtoToStaffManagementUpdateViewProfile()
    {
        CreateMap<StaffBasicDto, StaffManagementUpdateViewModel>()
